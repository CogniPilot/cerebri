...
static int casadi_f5(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  w[20]=(w[12]?w[20]:0);
  w[16]=(w[16]+w[20]);
  if (res[0]!=0) res[0][1]=w[16];
  w[19]=(w[2]*w[19]);
  w[15]=(w[3]*w[15]);
  w[9]=(w[5]*w[9]);
  w[15]=(w[15]+w[9]);
  w[19]=(w[19]-w[15]);
  if (res[0]!=0) res[0][2]=w[19];
  w[19]=0.;
  w[15]=(w[13]+w[10]);
  w[15]=(w[15]+w[2]);
  w[19]=(w[19]<w[15]);
  ...
  w[22]=(w[22]-w[5]);
  w[15]=(w[15]+w[22]);
  if (res[4]!=0) res[4][1]=w[15];
  w[31]=(w[31]*w[1]);
  w[21]=(w[21]*w[20]);
  w[26]=(w[26]*w[0]);
  w[21]=(w[21]-w[26]);
  w[31]=(w[31]+w[21]);
  if (res[4]!=0) res[4][2]=w[31];
  if (res[5]!=0) res[5][0]=w[4];
  return 0;
}
...
const char* bezier_multirotor_name_out(casadi_int i) {
  switch (i) {
    ...
    case 2: return "z";
    case 3: return "psi";
    case 4: return "psidot";
    case 5: return "psiddot";
    case 6: return "v";
    case 7: return "a";
    case 8: return "j";
    case 9: return "s";
