...
/* attitude_rate_control:(kp[3],ki[3],i_max[3],omega[3],omega_r[3],i0[3],dt)->(M[3],i1[3]) */
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  if (res[1]!=0) res[1][0]=w[6];
  if (res[1]!=0) res[1][1]=w[4];
  if (res[1]!=0) res[1][2]=w[5];
  return 0;
}
...
casadi_int attitude_rate_control_n_in(void) { return 7;}
...
/* position_control:(thrust_trim,pt_w[3],vt_w[3],at_w[3],qc_wb[4],p_w[3],v_b[3],q_wb[4],z_i,dt)->(nT,qr_wb[4],z_i_2) */
static int casadi_f2(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  w[19]=arg[3]? arg[3][0] : 0;
  w[19]=(w[8]*w[19]);
  w[2]=(w[2]+w[19]);
  w[19]=casadi_sq(w[2]);
  w[21]=arg[5]? arg[5][1] : 0;
  w[22]=arg[1]? arg[1][1] : 0;
  w[21]=(w[21]-w[22]);
  w[21]=(w[1]*w[21]);
  w[14]=(w[14]+w[15]);
  w[14]=(w[3]*w[14]);
  ...
  w[14]=(w[3]*w[14]);
  w[21]=(w[21]-w[14]);
  w[14]=arg[3]? arg[3][1] : 0;
  w[14]=(w[8]*w[14]);
  w[21]=(w[21]+w[14]);
  w[14]=casadi_sq(w[21]);
  w[19]=(w[19]+w[14]);
  w[14]=arg[5]? arg[5][2] : 0;
  w[6]=arg[1]? arg[1][2] : 0;
  w[14]=(w[14]-w[6]);
  w[1]=(w[1]*w[14]);
  w[16]=(w[16]-w[18]);
...
casadi_int joy_acro_n_in(void) { return 6;}
...
const char* joy_acro_name_in(casadi_int i) {
  switch (i) {
    ...
    case 2: return "joy_roll";
    case 3: return "joy_pitch";
    case 4: return "joy_yaw";
    case 5: return "joy_thrust";
    default: return 0;
  }
}
...
casadi_int joy_auto_level_n_in(void) { return 7;}
