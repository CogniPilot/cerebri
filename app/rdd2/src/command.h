...
struct context {
	...
	synapse_pb_Vector3 angular_velocity_ff, force_sp, accel_sp, moment_ff, velocity_sp,
		position_sp;
	...
	struct zros_pub pub_attitude_sp, pub_angular_velocity_ff, pub_force_sp, pub_accel_sp,
