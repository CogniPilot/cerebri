...
## Summary
`CUBS2` v1 flight hardware is locked to the Tropic stack of CRSF, FlexIO DSHOT, ICM45686, and staged M10 GNSS on `mr_vmu_tropic`, while `native_sim` is allowed only for non-flight SITL.
