...
ZROS_TOPIC_DECLARE(topic_offboard_bezier_trajectory, synapse_msgs_BezierTrajectory);
ZROS_TOPIC_DECLARE(topic_offboard_clock_offset, synapse_msgs_Time);
ZROS_TOPIC_DECLARE(topic_offboard_cmd_vel, synapse_msgs_Twist);
ZROS_TOPIC_DECLARE(topic_offboard_input, synapse_msgs_Input);
ZROS_TOPIC_DECLARE(topic_offboard_odometry, synapse_msgs_Odometry);
