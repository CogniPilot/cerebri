...
#define RDD2_ATTITUDE_AUTOLEVEL_DIV \
	(RDD2_CONTROL_RATE_HZ / RDD2_ATTITUDE_AUTOLEVEL_RATE_HZ)
#define RDD2_ATTITUDE_BACKGROUND_DIV \
	(RDD2_CONTROL_RATE_HZ / RDD2_ATTITUDE_BACKGROUND_RATE_HZ)
