...
rdd2_topic_rc_channels_data_const(const synapse_topic_RcChannels16_t *rc)
{
	return &rc->ch0;
}
...
rdd2_topic_rate_triplet_data_const(const synapse_topic_RateTriplet_t *rate)
{
	return &rate->roll;
}
...
static inline const float *
rdd2_topic_attitude_euler_data_const(const synapse_topic_AttitudeEuler_t *attitude)
{
	return &attitude->roll;
}
...
static inline const float *
rdd2_topic_motor_values_data_const(const synapse_topic_MotorValues4f_t *motors)
{
	return &motors->m0;
}
...
rdd2_topic_motor_raw_data_const(const synapse_topic_MotorRaw4u16_t *raw)
{
	return &raw->m0;
}
