...
**REQUIRED:**
- Topic schemas live in `modules/lib/synapse_msgs_fbs/fbs/cerebri/` as `.fbs` files.
...
- Fixed-size topic tables may be encoded with bounded hand-packed blob writers when needed to keep the 800 Hz path heap-free.
...
**PROHIBITED:**
- Heap allocation or dynamic builders in the 800 Hz control loop.
