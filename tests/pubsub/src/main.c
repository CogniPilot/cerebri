...
static void sub_entry_point(void *p0, void *p1, void *p2)
{
	...
	while (true) {
		...
		if (zros_sub_update_available(&sub_imu)) {
			...
			LOG_DBG("sub %d, imu: %10.4f %10.4f %10.4f", id, imu->angular_velocity.x,
		...
		if (zros_sub_update_available(&sub_battery)) {
			...
			LOG_DBG("sub %d, battery: %10.4f %10.4f", id, battery->voltage,
				battery->current);
		}
	}
 ...
 ********************************************************************/
#if PUBLISHER_COUNT > 0
K_THREAD_DEFINE(pub0, MY_STACK_SIZE, pub_entry_point, 0, NULL, NULL, 1, 0, 0);
#endif

#if PUBLISHER_COUNT > 1
K_THREAD_DEFINE(pub1, MY_STACK_SIZE, pub_entry_point, 1, NULL, NULL, 2, 0, 0);
#endif

#if PUBLISHER_COUNT > 2
K_THREAD_DEFINE(pub2, MY_STACK_SIZE, pub_entry_point, 2, NULL, NULL, 3, 0, 0);
#endif

#if PUBLISHER_COUNT > 3
K_THREAD_DEFINE(pub3, MY_STACK_SIZE, pub_entry_point, 3, NULL, NULL, 4, 0, 0);
#endif

#if PUBLISHER_COUNT > 4
K_THREAD_DEFINE(pub4, MY_STACK_SIZE, pub_entry_point, 4, NULL, NULL, 1, 0, 0);
#endif

#if PUBLISHER_COUNT > 5
K_THREAD_DEFINE(pub5, MY_STACK_SIZE, pub_entry_point, 5, NULL, NULL, 2, 0, 0);
#endif
 ...
 ********************************************************************/
#if SUBSCRIBER_COUNT > 0
K_THREAD_DEFINE(sub0, MY_STACK_SIZE, sub_entry_point, 0, NULL, NULL, 4, 0, 0);
#endif

#if SUBSCRIBER_COUNT > 1
K_THREAD_DEFINE(sub1, MY_STACK_SIZE, sub_entry_point, 1, NULL, NULL, 5, 0, 0);
#endif

#if SUBSCRIBER_COUNT > 2
K_THREAD_DEFINE(sub2, MY_STACK_SIZE, sub_entry_point, 2, NULL, NULL, 5, 0, 0);
#endif

#if SUBSCRIBER_COUNT > 3
K_THREAD_DEFINE(sub3, MY_STACK_SIZE, sub_entry_point, 3, NULL, NULL, 5, 0, 0);
#endif

#if SUBSCRIBER_COUNT > 4
K_THREAD_DEFINE(sub4, MY_STACK_SIZE, sub_entry_point, 4, NULL, NULL, 5, 0, 0);
#endif

#if SUBSCRIBER_COUNT > 5
K_THREAD_DEFINE(sub5, MY_STACK_SIZE, sub_entry_point, 5, NULL, NULL, 5, 0, 0);
#endif
